...
class TestBaseModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.__class__.expObjective = 21800
    ...
    def runOptimization(self):
        ...
        parameter = example.parameter_add_genset_multinode_test(parameter)
        ...
        self.__class__.fuelCost = model.fuel_cost_total.value
    ...
    def test_fuel_cost_nonxero(self):
        self.assertGreater(self.fuelCost, 0, msg='total fuel costs is zero')
    ...
    def test_pyomo_has_genset_output(self):
        self.assertTrue(hasattr(self.model, 'sum_genset_power'), msg='pyomo model is missing key var: sum_genset_power')
